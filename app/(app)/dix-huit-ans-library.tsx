...
import { DIX_HUIT_ANS_GROUPS, type DixHuitAnsSubGroup } from '../../src/constants/dixHuitAnsMessages';
...
export default function DixHuitAnsLibraryScreen() {
  const C = useColors();
  ...
  const [selectedGroup, setSelectedGroup] = useState<DixHuitAnsSubGroup | null>(null);
  ...
  const totalMessages = DIX_HUIT_ANS_GROUPS.reduce((a, g) => a + g.messages.length, 0);
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: C.background }]} edges={['top']}>
      <View style={styles.topbar}>
        ...
        <Text style={styles.topbarTitle}>🔞 18 ans</Text>
