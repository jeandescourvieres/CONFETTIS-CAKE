  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <View style={{ borderRadius: Radii.xl, borderWidth: 1.5, borderColor: '#FBCFE8', backgroundColor: '#FFF1F7', padding: 16, gap: 10 }}>
          <View style={styles.guideModeHeader}>
            <Text style={styles.guideModeEmoji}>🎙️</Text>
            <Text style={[styles.guideModeLabel, { color: '#BE185D' }]}>Tu peux envoyer un message vocal :</Text>
          </View>
